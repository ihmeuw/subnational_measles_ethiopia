...
##   data.tables. For more information about setting up a DB connection, visit
##   URLPATH
################################################################################
...
#'   results into a named list of database connection definitions. For more
#'   information about setting up the ".odbc.ini" file, see
#'   URLPATH.
#'
...
#'   a DBMS. For more information, see URLPATH
#'
...
#'   file and create a connection to the specified database. For more information,
#'   see URLPATH.
