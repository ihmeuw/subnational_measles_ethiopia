...
#' link <- vr_pull_link_table(shapefile_path = "FILEPATH")
#' 
...
#'                            
#' using shapefile path:
#' link <- vr_pull_adjacency_matrix(shapefile_path = "FILEPATH", suffix = "W")
#' 
...
vr_get_population <- function(ages = seq(0, 80, 5),
  ...
  shapefile_path <- vr_pull_shp(paste0(country, "_", admin), "stable", "full")$shapefile
