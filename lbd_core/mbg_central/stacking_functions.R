...
# a .#### at the end of the layer name (usually within a brick). 
...
#adapted from USERNAME's BRT covs function-- took away the year specific bit. GBMs==BRTs
...
#' @param period  what period should be used. 1:N -- we assume 4, Default: 1
