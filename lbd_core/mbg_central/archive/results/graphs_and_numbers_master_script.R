##########
# Main script to run markdown, and any other plots and numbers you want regularly pulled from your model runs. 
##########
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
rmarkdown::render(paste0("FILEPATH"),
...
write.csv(corrs, file=paste0("FILEPATH"))
