...
in `FILEPATH`, create means from the draws and
save out a CSV and RDS file in `FILEPATH`
...
def get_xarray_mean(pop_version):
    """ Loads the population xarray from FILEPATH
