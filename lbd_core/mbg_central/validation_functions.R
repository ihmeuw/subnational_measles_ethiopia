...
plot.rfs <- function(ind.gp = indicator_group,
  ...
  regions <- get_output_regions(in_dir = paste0('FILEPATH'))
...
####################################################################################################################
## INPUT: # data file matching FILEPATH
...
#' @param input_file If your team does not use the standard `FILEPATH` input data filepath, supply the filepath to your data here
#' @param admin0_file If your team does not use the standard `FILEPATH` directory to save unraked aggregated admin summaries, supply the correct filepath here
#' @param admin1_file If your team does not use the standard `FILEPATH` directory to save unraked aggregated admin summaries, supply the correct filepath here
#' @param admin2_file If your team does not use the standard `FILEPATH` directory to save unraked aggregated admin summaries, supply the correct filepath here
#' 
...
get_admin_pv <- function(indicator, 
  ...
  if(is.null(input_file)){
    if(!file.exists(paste0('FILEPATH'))) stop('Indicator input data does not exist in FILEPATH - please specify a file path with the input_file arg')
    input.dt <- fread(paste0('FILEPATH'))
  } else{
