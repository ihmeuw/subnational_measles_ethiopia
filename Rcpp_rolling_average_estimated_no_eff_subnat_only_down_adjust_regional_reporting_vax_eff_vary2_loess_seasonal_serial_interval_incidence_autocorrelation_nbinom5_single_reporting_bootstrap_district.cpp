    ...
    for(int VALUES = 0; VALUES < 79 ; VALUES ++){
      ...
      if(bootstrap_lookup(q8,VALUES) == 1){
        ...
        if( std::find(v1.begin(), v1.end(), VALUES) != v1.end()){
          loglike += (dnbinom_nonint(cases_age_bin0_4_matrix(q8,VALUES), I_final_district_counts_0_4(q8,VALUES) * rho, 5) * autocorrelation(VALUES,0));
          loglike += (dnbinom_nonint(cases_age_bin5_9_matrix(q8,VALUES), I_final_district_counts_5_9(q8,VALUES) * rho, 5) * autocorrelation(VALUES,1));
          loglike += (dnbinom_nonint(cases_age_bin10_14_matrix(q8,VALUES), I_final_district_counts_10_14(q8,VALUES) * rho, 5) * autocorrelation(VALUES,2));
          loglike += (dnbinom_nonint(cases_age_bin15_24_matrix(q8,VALUES), I_final_district_counts_15_24(q8,VALUES) * rho, 5) * autocorrelation(VALUES,3));
          loglike += (dnbinom_nonint(cases_age_bin25_34_matrix(q8,VALUES), I_final_district_counts_25_34(q8,VALUES) * rho, 5) * autocorrelation(VALUES,4));
          loglike += (dnbinom_nonint(cases_age_bin35_44_matrix(q8,VALUES), I_final_district_counts_35_44(q8,VALUES) * rho, 5) * autocorrelation(VALUES,5));
          loglike += (dnbinom_nonint(cases_age_bin45_54_matrix(q8,VALUES), I_final_district_counts_45_54(q8,VALUES) * rho, 5) * autocorrelation(VALUES,6));
          loglike += (dnbinom_nonint(cases_age_bin55_64_matrix(q8,VALUES), I_final_district_counts_55_64(q8,VALUES) * rho, 5) * autocorrelation(VALUES,7));
          loglike += (dnbinom_nonint(cases_age_bin65_plus_matrix(q8,VALUES), I_final_district_counts_65_plus(q8,VALUES) * rho, 5) * autocorrelation(VALUES,8));
        }
